        ...
        <div className="max-w-[1240px] mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <section className="pt-[40px] pb-[40px] border-t border-cv-line dark:border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
              <a href="https://devx.cloudverse.ai" target="_blank" rel="noopener noreferrer" onClick={() => track("product_devx", { location: "products_section" })} className="group relative bg-cv-surface2/50 dark:bg-slate-800/50 border border-cv-line dark:border-slate-700/50 rounded-2xl p-6 sm:p-8 hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-300 is_cvdevx" data-testid="product-devx-card">
              ...
              <a href="https://aix.cloudverse.ai" target="_blank" rel="noopener noreferrer" onClick={() => track("product_aix", { location: "products_section" })} className="group relative bg-cv-surface2/50 dark:bg-slate-800/50 border border-cv-line dark:border-slate-700/50 rounded-2xl p-6 sm:p-8 hover:border-purple-500/50 hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 is_cvaix" data-testid="product-aix-card">
                <div className="flex flex-col gap-4">
              ...
              <a href="https://datax.cloudverse.ai" target="_blank" rel="noopener noreferrer" onClick={() => track("product_datax", { location: "products_section" })} className="group relative bg-cv-surface2/50 dark:bg-slate-800/50 border border-cv-line dark:border-slate-700/50 rounded-2xl p-6 sm:p-8 hover:border-pink-500/50 hover:shadow-lg hover:shadow-pink-500/10 transition-all duration-300 is_cvdatax" data-testid="product-datax-card">
                <div className="flex flex-col gap-4">
              ...
              <a href="https://billops.cloudverse.ai" target="_blank" rel="noopener noreferrer" onClick={() => track("product_billops", { location: "products_section" })} className="group relative bg-cv-surface2/50 dark:bg-slate-800/50 border border-cv-line dark:border-slate-700/50 rounded-2xl p-6 sm:p-8 hover:border-orange-500/50 hover:shadow-lg hover:shadow-orange-500/10 transition-all duration-300 is_cvbillops" data-testid="product-billops-card">
                <div className="flex flex-col gap-4">
