...
const features: { title: string; desc: string; icon: LucideIcon }[] = [
  {
    ...
    desc: "Track spend, usage, and trends across teams.",
    icon: BarChart3,
  },
  {
    title: "Developer FinOps (shift-left)",
    desc: "Put cost signals into dev workflows early.",
    icon: Code2,
  },
  {
    title: "Allocation & chargeback",
    desc: "Attribute costs to owners with confidence.",
    icon: Target,
  },
  {
    title: "Autonomous tag normalization",
    desc: "Clean and standardize tags automatically.",
    icon: Tag,
  },
  {
    title: "Detected + predicted anomalies",
    desc: "Spot spikes now and forecast risk.",
    icon: Search,
  },
  {
    title: "Enterprise access controls",
    desc: "Role-based access and auditability built in.",
    icon: Shield,
  },
  {
    title: "Automation-first optimization",
    desc: "Turn savings actions into policies.",
    icon: Settings,
  },
  {
    title: "Audit logs and governance",
    desc: "Full change history for compliance.",
    icon: ClipboardList,
  },
];
            ...
            {features.map((feature, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h4 className="font-medium text-cv-ink mb-1 text-[16px]">
                    {feature.title}
                  </h4>
                  <p className="text-cv-muted dark:text-slate-500 text-[14px]">
                    {feature.desc}
                  </p>
                </div>
              );
        ...
        <section className="pt-[40px] pb-[40px] border-t border-cv-line dark:border-white/10">
          <div className="mb-12 sm:mb-14">
            ...
            <p className="sm:text-xl text-cv-muted dark:text-slate-400 max-w-2xl text-[18px]">
              See how CloudVerse™ can help your team gain visibility, control
              costs, and unlock savings across your cloud infrastructure.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            <a
              ...
              onClick={() =>
                track("product_devx", { location: "products_section" })
              }
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() =>
                track("product_aix", { location: "products_section" })
              }
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() =>
                track("product_datax", { location: "products_section" })
              }
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-cv-muted leading-relaxed mb-4 text-sm sm:text-base">
                    Analytics data cost visibility and workload controls.
                    Monitor usage, optimize queries, and control spend.
                  </p>
            ...
            <a
              ...
              rel="noopener noreferrer"
              onClick={() =>
                track("product_billops", { location: "products_section" })
              }
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <p className="text-cv-muted leading-relaxed mb-4 text-sm sm:text-base">
                    Unified cloud billing and cost operations. Track usage,
                    allocate costs, enforce controls.
                  </p>
