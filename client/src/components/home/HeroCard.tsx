...
export function HeroCard() {
  return (
    <div className="w-full lg:w-[480px] xl:w-[540px] 2xl:w-[580px] rounded-[28px] border border-cv-line dark:border-slate-700/50 bg-cv-surface dark:bg-slate-900 overflow-hidden shadow-xl shadow-black/20 relative flex flex-col">
