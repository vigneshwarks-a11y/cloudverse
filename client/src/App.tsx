...
import AICloudVerse from "@/pages/AICloudVerse";
import AICapabalities from "@/pages/AICapabalities";
import AIFeatures from "@/pages/AIFeatures";
import AIWhoIsCloudverseFor from "@/pages/AIWhoIsCloudverseFor";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/ai/cloudverse" component={AICloudVerse} />
      <Route path="/ai/capabalities" component={AICapabalities} />
      <Route path="/ai/features" component={AIFeatures} />
      <Route path="/ai/who-is-cloudverse-for" component={AIWhoIsCloudverseFor} />
      ...
      <Route path="/ai/capabilities"><Redirect to="/ai/capabalities" /></Route>
      <Route path="/ai/who-is-cloudverse-for/"><Redirect to="/ai/who-is-cloudverse-for" /></Route>
