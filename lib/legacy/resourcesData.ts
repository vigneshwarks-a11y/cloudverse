...
export const resourcesData: Resource[] = [
  // Guides
  {
    ...
    content: [
      ...
      "The CloudVerse Approach: Visibility That Operates at Decision Time<br /><br /><b>CloudVerse</b> functions as an economic intelligence layer above cloud, data, and AI systems.<br /><br />By embedding economic signals into engineering (Torb), data platforms (DataX), and AI/GPU workflows (Agentry), <b>CloudVerse</b> turns <b style=\"color: #1664C0;\">cloud cost governance</b> into a continuous, decision-aware system rather than a monthly exercise.",
