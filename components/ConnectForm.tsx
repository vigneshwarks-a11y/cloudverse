...
export function ConnectForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-2xl border border-cv-line/60 bg-cv-surface2 dark:bg-cv-card p-6 sm:p-7 space-y-3.5" data-testid="connect-form">
      ...
      <button type="submit" disabled={status === "submitting"} className="cv-btn-primary w-full justify-center py-2.5 text-sm disabled:opacity-60" data-testid="button-submit-demo">
