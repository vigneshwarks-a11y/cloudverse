...
function useNumberFlowElementReady(): boolean {
  ...
  // (both emit the static string); upgrade to the animated element only after
  // mount. Seeding from `customElements` at init causes a hydration mismatch,
  // because the custom element registers synchronously on the client import but
  // is never defined on the server.
