...
const PRODUCTS: { name: string; tagline: string; icon: Icon; href: string }[] = [
  { name: "Agentry", tagline: "Catch cloud cost mistakes before they hit production.", icon: MagicStick2, href: PRODUCT_URLS.aix },
  { name: "Torb", tagline: "Cut AI costs without breaking latency or quality.", icon: Box, href: PRODUCT_URLS.devx },
