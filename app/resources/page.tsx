    ...
    <>
      <section className="cv-hero-bg pt-[140px] pb-12 lg:pt-[160px] lg:pb-16 relative">
        <div className="cv-container relative z-10">
          ...
          <h1 className="cv-h1 text-white max-w-3xl">Practitioner-grade reading on compute economics.</h1>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {RESOURCES.map((r) => (
              <Link
                ...
                className="group rounded-xl border border-white/10 bg-white/[0.02] p-6 hover:bg-white/[0.04] transition-colors flex flex-col"
              ...
              >
                ...
                <div className="font-display font-semibold text-white text-lg leading-snug">{r.title}</div>
                <p className="text-white/65 text-sm mt-3 leading-relaxed flex-1">{r.excerpt}</p>
