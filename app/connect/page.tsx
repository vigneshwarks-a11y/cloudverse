      ...
      <div className="cv-container relative z-10">
        <div className="grid lg:grid-cols-12 gap-10 items-start">
          <div className="lg:col-span-6">
            ...
            <p className="cv-body-lg mt-6 text-white/75 max-w-xl">
            ...
            <ul className="mt-8 space-y-3">
              {PROOF.map((p) => (
                <li key={p} className="flex gap-3 text-white/85 text-[15px]">
            ...
            <div className="mt-10 pt-8 border-t border-white/10">
              <div className="cv-label mb-3 text-white/50">Prefer to talk to sales?</div>
          ...
          <div className="lg:col-span-6">
            ...
            >
              <div className="font-display text-white text-2xl font-bold mb-2">
                Book your slot
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-white/10 text-white/55 text-xs">
